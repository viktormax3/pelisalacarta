...
class Item(object):
    ...
    def fromurl(self,url):
        ...
        Tambien es capaz de generar el item a partir de una cadena de texto con formato "campo1=valor1&campo2=valor2..."
        ...
        try:
          ...
          dct = {param.split("=")[0]:param.split("=")[1] for param in url.split("&")}
