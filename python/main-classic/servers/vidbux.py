...
def get_video_url(page_url, premium=False, user="", password="", video_password=""):
    ...
    if len(matches) > 0:
        data = matches[0]
        logger.info("bloque packed=" + data)
    else:
        logger.info("no encuentra bloque packed=" + data)
