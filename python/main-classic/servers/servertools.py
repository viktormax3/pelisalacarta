...
FREE_SERVERS = []
FREE_SERVERS.extend(['directo','allmyvideos','adnstream','divxstage','facebook','fourshared', 'hulkshare', 'twitvid'])
...
FREE_SERVERS.extend(['jumbofiles','nowvideo','streamcloud', 'dailymotion','justintv', 'vidbull'])
FREE_SERVERS.extend(['nosvideo','videopremium','movreel','flashx','upafile'])
...
FREE_SERVERS.extend(['vodlocker','thevideome','rocvideo','vidxtreme','vidtome','vidzi','letwatch','sendvid','vkpass','okru','cnubis','yourupload','mp4upload']) #,'vimpleru'])
...
REALDEBRID_SERVERS = ['one80upload','tenupload','onefichier','onehostclick','twoshared','fourfastfile','fourshared','abc','asfile','badongo','bitshare','cbscom','cramit','crocko','cwtv','dailymotion','dateito',
                   ...
                   'userporn','veevr','vidbux','vidxden','vimeo','vipfile','wattv','xfileshare','youporn','youtube','yunfile','zippyshare','justintv','nowvideo','filesmonster','oboom','hugefiles']
#wupload,fileserve

ALLDEBRID_SERVERS = ['one80upload','onefichier','twoshared','fourfastfile','fourshared','albafile','bitshare','cramit','crocko','cyberlocker','dailymotion','dengee',
